...
const EditProductModal = ({ isOpen, onClose, onSave, product }) => {
  ...
  // Pre-populate form with product data when the modal opens
  useEffect(() => {
    if (product) {
      setFormData({
        name: product.name || '',
  ...
  const handleSubmit = (e) => {
    ...
    // Include both _id and id to handle MongoDB and other scenarios
    ...
    // Call onSave to update the product
