...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8"
         style={{
           backgroundImage: 'url("https://img.freepik.com/free-vector/abstract-realistic-technology-particle-background_23-2148420657.jpg?t=st=1746285610~exp=1746289210~hmac=ef9ee9e37723b6c9308e2f1cabeba34ddaff9226e6ca116710967b1d6907f643&w=996")',
      ...
      <div className="max-w-md w-full bg-gray-900 rounded-lg shadow-xl overflow-hidden animate-fadeIn bg-opacity-90">
        <div className="px-6 py-8">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-center text-2xl font-bold text-white">Réinitialiser votre mot de passe</h2>
          </div>
